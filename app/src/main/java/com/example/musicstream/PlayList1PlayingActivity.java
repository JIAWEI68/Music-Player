...
public class PlayList1PlayingActivity extends AppCompatActivity {
    ...
    public PlayList1SongCollection songCollection = new PlayList1SongCollection();
    SeekBar seekBar;
    ...
    PlayList1SongCollection originalSongCollection = new  PlayList1SongCollection();
    List<Song> shuffleList = Arrays.asList(songCollection.songs);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_play_list1_playing);
    ...
    public void shuffle(View view) {
        if (shuffleFlag){
            ...
            songCollection = new PlayList1SongCollection();
        }
        else{
