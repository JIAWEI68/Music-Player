...
public class PlayList2PlayingActivity extends AppCompatActivity {
    ...
    public PlayList2SongCollection songCollection = new PlayList2SongCollection();
    SeekBar seekBar;
    ...
    PlayList2SongCollection originalSongCollection = new  PlayList2SongCollection();
    List<Song> shuffleList = Arrays.asList(songCollection.songs);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_play_list2_playing);
    ...
    public void shuffle(View view) {
        if (shuffleFlag){
            ...
            songCollection = new PlayList2SongCollection();
        }
        else{
    ...
    public void goBack(View view) {
        Intent intent = new Intent(PlayList2PlayingActivity.this, PlayList2Activity.class);
        player.release();
        handler.removeCallbacks(bar);
